...
moduleForModel('i-i-s-finalnyjj-proekt-графики-отпуска', 'Unit | Serializer | i-i-s-finalnyjj-proekt-графики-отпуска', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-finalnyjj-proekt-графики-отпуска',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
