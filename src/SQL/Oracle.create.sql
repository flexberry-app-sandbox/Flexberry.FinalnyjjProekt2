...
(
	...
	"КодСотру" NUMBER(10) NOT NULL,

	"Имя" NVARCHAR2(255) NOT NULL,

	"НомерПас" NUMBER(10) NULL,

	"Отчество" NVARCHAR2(255) NOT NULL,
